...
func TestStripSlashes(t *testing.T) {
	...
	// this middleware must be mounted at the top level of the router,
	// not at the end-handler because then it'll be too late and will end up in a 404
	r.Use(StripSlashes)
	...
	r.Route("/accounts/{accountID}", func(r gor.Router) {
		r.Get("/", func(w http.ResponseWriter, r *http.Request) {
			accountID := gor.URLParam(r, "accountID")
...
// this tests a http.Handler that is not gor.Router In these cases, the routeContext is nil
